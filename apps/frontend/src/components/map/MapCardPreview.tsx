    ...
    <div className="w-full max-w-sm bg-white rounded-2xl shadow-2xl border border-sand-200 overflow-hidden text-sand-900 transition-all animate-in fade-in zoom-in-95 duration-200">
      ...
      <div className="relative h-44 w-full overflow-hidden bg-sand-200">
        ...
        <div className="absolute top-3 left-3 flex items-center gap-1.5">
          ...
          >
            {isAccommodation ? '🏡 Alojamiento Habilitado' : '⛰️ Circuito Natural'}
          </span>
        </div>
        ...
        <button
          ...
          className="absolute top-3 right-3 w-8 h-8 rounded-full bg-black/40 hover:bg-black/60 text-white flex items-center justify-center text-sm transition-colors cursor-pointer"
        >
          ✕
        </button>
        ...
        <div className="absolute bottom-3 left-3 text-white">
          <span className="text-xs uppercase font-bold tracking-wider text-sand-200">
            {place.category}
          </span>
          <h4 className="font-display font-bold text-lg leading-tight drop-shadow-sm">
            {place.title}
          </h4>
        </div>
      </div>
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-center justify-between text-xs py-1 border-y border-sand-100">
          ...
          <div className="text-sand-600 truncate max-w-[180px]">
            📍 {place.address}
          </div>
        </div>
        ...
        {isAccommodation ? (
          <div className="flex items-center justify-between pt-1">
            <div>
              <span className="text-xs text-sand-500 block">Tarifa por noche</span>
          ...
          <div className="flex items-center justify-between pt-1">
            <div>
              <span className="text-xs text-sand-500 block">Dificultad: {place.difficulty}</span>

  ...
  return (
    <section className="space-y-6 pt-8 border-t border-sand-200/80">
      <div className="flex items-center justify-between pb-1">
        <h3 className="font-display font-black text-xl text-sand-950 flex items-center gap-2.5">
      ...
      {isTrekking && (
        <div className="pt-3 border-t border-sand-200/80 flex flex-wrap items-center justify-between gap-3 text-xs text-sand-600">
